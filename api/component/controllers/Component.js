...
/**
 * A set of functions called "actions" for `component`
 */
...
module.exports = {
  ...
  /**
   * Add an entry to a specific component.
   *
   * @return {Object}
   */
  ...
  /**
   * Remove a specific entry from a specific component.
   *
   * @return {Object}
   */
